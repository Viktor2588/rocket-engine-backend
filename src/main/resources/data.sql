...
-- Using camelCase column names as defined in the Entity class
-- Reserved keyword 'use' must be quoted

INSERT INTO engines (name, origin, designer, vehicle, status, "use", propellant, powerCycle, isp_s, thrustN, chamberPressureBar, massKg, thrustToWeightRatio, ofRatio, description)
